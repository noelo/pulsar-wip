...
class CryptoDataProducerTest {
    ...
    void currencyTest() throws CsvValidationException, IOException, ExecutionException, InterruptedException {
        CryptoCurrencyDataProducer x = new CryptoCurrencyDataProducer("persistent://public/default/currency","data/crypto/All_Currencies_Table.csv");
    }


    @org.junit.jupiter.api.Test
    void pricesTest() throws CsvValidationException, IOException, ExecutionException, InterruptedException {
        CryptoPricesDataProducer x = new CryptoPricesDataProducer("persistent://public/default/prices","data/crypto/Cryptocurrency_Prices_by_Date.csv");
    }
}